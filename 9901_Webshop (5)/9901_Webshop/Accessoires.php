        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="Accessoires.php" class="nav-link px-2 navText activeSite">Accessoires</a></li>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                    ...
                    //Display products
                    $sql = "SELECT productId, category, price, productName, productDes, productStock, picture FROM product where category = 'Accessoires'";
